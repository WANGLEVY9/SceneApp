...
CREATE TABLE IF NOT EXISTS `scene_merchant` (
  ...
  `hot` int NOT NULL DEFAULT 0 COMMENT '热度值（用于排序）'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='商家表';

-- 若历史库缺少 desc 列，请执行：
-- ALTER TABLE scene_merchant ADD COLUMN `desc` varchar(512) DEFAULT '' AFTER lng;